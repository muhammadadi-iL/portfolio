...
const TooltipContent = () => {
  return (
    <Card>
      ...
      <CardHeader title={`${themeConfig.templateName} - MUI Next.js Admin Panel`} />
      <CardContent>
        <Typography color='textSecondary' className='mbe-4'>
          {`${themeConfig.templateName} is the most developer friendly & highly customizable Admin Dashboard Template based on MUI and Next.js.`}
        </Typography>
